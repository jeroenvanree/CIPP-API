...
if ($env:WEBSITE_RUN_FROM_PACKAGE -ne '1') { $Alerts.add('Your Function App is running in write mode. Please check the release notes to enable Run from Package mode. (https://github.com/jeroenvanree/CIPP/releases/tag/v2.1.11.0)') }
try {
